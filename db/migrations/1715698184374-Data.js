module.exports = class Data1715698184374 {
    name = 'Data1715698184374'
    ...
    async up(db) {
        ...
        await db.query(`CREATE TABLE "protocol_state" ("id" character varying NOT NULL, "block_number" integer NOT NULL, "timestamp" numeric NOT NULL, "period" integer NOT NULL, "subperiod" character varying(12) NOT NULL, CONSTRAINT "PK_94104c92dd535f589ce92eb2534" PRIMARY KEY ("id"))`)
        await db.query(`CREATE INDEX "IDX_9754140fb2d76ad4c79266c054" ON "protocol_state" ("block_number") `)
    ...
    async down(db) {
        ...
        await db.query(`DROP TABLE "protocol_state"`)
        await db.query(`DROP INDEX "public"."IDX_9754140fb2d76ad4c79266c054"`)
