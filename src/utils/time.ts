...
export function getFirstTimestampOfThePreviousDay(timestamp: number): number {
  const previousDayLastSecond = getFirstTimestampOfTheDay(timestamp) - 1000;
  
  return getFirstTimestampOfTheDay(previousDayLastSecond);
}
